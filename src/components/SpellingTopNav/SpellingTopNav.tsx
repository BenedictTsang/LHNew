...
interface SpellingTopNavProps {
  onCreateNew: () => void;
  onViewSaved: () => void;
  currentView?: 'create' | 'saved';
}

const SpellingTopNav: React.FC<SpellingTopNavProps> = ({ onCreateNew, onViewSaved, currentView = 'create' }) => {
  return (
